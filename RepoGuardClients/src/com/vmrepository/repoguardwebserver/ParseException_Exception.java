 ...
 * 
 */
@WebFault(name = "ParseException", targetNamespace = "http://RepoGuardWebServer.vmrepository.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.vmrepository.repoguardwebserver.ParseException
     */
