...
public class GetVMIBucketList {
	...
	public static void main(String[] args)
		...
		if (service.authenticate("FLEXIANT", "cVgZzW9Y&*xk%U=9")) {
			...
			/*
			 * Enter the node ID and container of S3 repository for querying images stored in the container of S3 repository with node ID 
			 */

			List bucketsList = service.getBucketVMIList(nodeId, "flexiant-entice");
